...
OUTPUT_DIR = 'output/pages/daily/jiqizhixin'
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='生成机器之心每日文章列表',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog='''
示例:
  # 使用当前日期（东8区）
  python scripts/generate_jiqizhixin_page.py
  
  # 指定日期
  python scripts/generate_jiqizhixin_page.py --date 2026-04-09
  
  # 使用昨天的日期
  python scripts/generate_jiqizhixin_page.py --date yesterday
        '''
    )
